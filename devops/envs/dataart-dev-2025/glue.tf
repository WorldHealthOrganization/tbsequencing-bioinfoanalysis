...
locals {
  glue_jobs = {
    genotype = {
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/genotype-known"
    }
    new_var_genotype = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/genotype-new"
    }
    deletion = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/deletion"
    }
    locus_stats = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/locus-stats"
    }
    taxonomy_assignment = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/taxonomy-assignment"
    }
    global_stats = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/global-stats"
    }
    del_variants = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
    ...
    data_extraction = {
      ...
      default_arguments = {
        ...
        "--TempDir"               = "s3://${module.s3_for_fsx.bucket_id["glue-logs-bucket"]}/",
        "--enable-spark-ui"       = true
        "--spark-event-logs-path" = "s3://${module.s3_for_fsx.bucket_id["glue-logs-bucket"]}/spark-logs/data_extraction/"
      }
    ...
    join_genotype = {
      ...
      script_location = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/join-genotype"
    }
    predict_resistance = {
      role_arn          = aws_iam_role.glue_role.arn
      connections       = [module.glue.glue_connection_name["glue_connection"]]
    ...
    write_formatted_annotations_per_gene = {
      ...
      default_arguments = {
        "--job-bookmark-option"      = "job-bookmark-enable",
        "--enable-spark-ui"          = "true",
        "--extra-py-files"           = "s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/variant_annotation_categorization.py,s3://${module.s3_for_fsx.bucket_id["glue-scripts"]}/glue-jobs/biosql_gene_views.py",
